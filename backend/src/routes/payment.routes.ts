 ...
 * Reading payments.
 *
 * Every role, scoped differently by the service: a driver sees their own, staff see collections
 * at their own company's stations. Same dual-scope shape as Module 7's sessions, because a
 * payment has the same two legitimate audiences.
 */
router.get(
  '/',
