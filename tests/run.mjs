...
const SUITES = [
  ...
  ['ocpp', 82, 'Module 6 — OCPP gateway (+2: Module 16 connector-release contract)'],
  ['fault', 48, 'Module 6 — charge-point vs connector faults (OCPP connectorId 0)'],
  ['session', 112, 'Module 7 — charging sessions'],
